...
asset_path = 'P:/projects/eaapexseason17_42048P/assets/3D'
...
with open(scene_csv) as f:
    ...
    for asset_type, asset_name in data:
        ...
        if 'bg' == asset_type:
            ...
            cmds.select(list)
            command = f'file -import -type "atomImport" -ra true -options ";;targetTime=2;dstTime=101:169;option=scaleInsert;match=mapFile;;selected=selectedOnly;search=;replace=;prefix=;suffix=;mapFile={mapfile};" {atomName};'
            mel.eval(command)
