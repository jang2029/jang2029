...
slateFile = r'Q:/pipeline_script/tgr/maya/2022/slate_cam.mb'
...
cmds.setAttr (camShapes+'.nearClipPlane', 0.1)
...
raw_name = raw_name.split('_')[0]+'_'+raw_name.split('_')[1]+'_'+raw_name.split('_')[2]+'_'+raw_name.split('_')[3]+'_'+raw_name.split('_')[4]+'_'+raw_name.split('_')[5]
shotName = filename.split('_')[0]+'_'+filename.split('_')[1]+'_'+raw_name.split('_')[2]+'_'+raw_name.split('_')[3]
