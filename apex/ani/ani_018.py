...
class AniToolUI(QWidget):
    ...
    def initUI(self):
        ...
        layoutPubOpen_btn.clicked.connect(self.layoutPubOpenBtn)
        layoutPubSave_btn.clicked.connect(self.layoutPubSaveBtn)
