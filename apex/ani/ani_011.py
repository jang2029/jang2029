...
class AniToolUI(QWidget):
    ...
    def getlayoutList(self):
        ...
        layout_path = f'{current_proj}/{current_ep}/sequences/{currentShot}/animation/work/maya/scene'

        for shot_name in sorted(os.listdir(layout_path)):
            if os.path.isdir(f'{shot_path}/{shot_name}'):
                self.layout_list.addItem(shot_name)
