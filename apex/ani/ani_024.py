...
class AniToolUI(QWidget):
    ...
    def aniSavePubBtn(self):
        ...
        if not os.path.isdir(path):
            os.makedirs(path)
        path = f'{PROJ_DRIVE}/{current_proj}/{current_ep}/sequences/{currentShot}/animation/output/camcache/animation_renderCam/{version}/alembic/{currentShot}_animation_renderCam_{version}'
