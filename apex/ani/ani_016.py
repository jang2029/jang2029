...
class AniToolUI(QWidget):
    ...
    def layoutSaveWIPBtn(self):
        ...
        version = int(raw_name[-3:])
        filename = raw_name[:-3]
        savename = filename+ str(version+1).zfill(3)
        savename = filepath+ savename
        print (filepath)
        print (savename)

        self.mayaCleanup()
        cmds.file(rn=savename)
    ...
    def initUI(self):
        ...
        layoutPubSave_btn.setFixedHeight(55)
        ...
        aniPubSave_btn.setFixedHeight(55)
