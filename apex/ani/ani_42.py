            ...
            with open(scene_csv) as f:
                ...
                for asset_type, asset_name in data:
                    ...
                    if 'bg' == asset_type:
                        ...
                        cmds.select(list)
                        command = f'file -force -options "precision=8;statics=1;baked=1;sdk=1;constraint=1;animLayers=1;selected=selectedOnly;whichRange=2;range={startFrame}:{endFrame};hierarchy=none;controlPoints=0;useChannelBox=2;options=keys;" -ch 1 -typ "atomExport" -es {atomName};'
                        mel.eval(command)
