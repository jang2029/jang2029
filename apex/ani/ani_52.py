...
class AniToolUI(QWidget):
    ...
    def aniSavePubBtn(self):
        ...
        command = f'AbcExport -j "-frameRange {startFrame} {endFrame} -ro -uvWrite -writeColorSets -writeFaceSets -wholeFrameGeo -worldSpace -writeVisibility -eulerFilter -autoSubd -writeUVSets -dataFormat ogawa -root {camName} -file {path}";'
        mel.eval(command)
    ...
    def initUI(self):
        ...
        column3_layout.addWidget(lightList_grp)
