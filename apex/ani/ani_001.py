...
class AniToolUI(QWidget):
    ...
    def getRigPubFile(self, save_version=None):
        ...
        save_file = f'{save_file}_{save_version}.ma'
    ...
    def assetRefBtn(self):
        ...
        pub_dir = self.getRigPubDir() + '/'+ selected_version + '/alembic'
        print ('pub_dir = '+pub_dir)
    ...
    def initUI(self):
        ...
        middle_ver_label = QLabel('Asset_Pub Ver')
        ...
        # model reference
        model_ref_btn = QPushButton('Asset import')
        model_ref_btn.clicked.connect(self.assetRefBtn)
