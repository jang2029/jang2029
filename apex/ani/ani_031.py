...
class AniToolUI(QWidget):
    ...
    def saveCurrentENV(self):
        ...
        env_docs = {
                    ...
                    'shot_name': shot_name, 'middle_name': middle_name, 'rig_pub_ver': rig_pub_ver,
    ...
    def getShotList(self):
        ...
        current_proj = self.proj_list.currentText()
        current_proj = f'{PROJ_DRIVE}/{current_proj}'
        shot_path = f'{current_proj}/{current_ep}/sequences'
    ...
    def getLayoutWip(self):
        ...
        layoutWip_path = f'{current_proj}/{current_ep}/sequences/{currentShot}/layout/work/maya/scene'
    ...
    def getLayoutPub(self):
        ...
        layoutPub_path = f'{current_proj}/{current_ep}/sequences/{currentShot}/layout/output/maya/scene'
    ...
    def getAniWip(self):
        ...
        aniWip_path = f'{current_proj}/{current_ep}/sequences/{currentShot}/animation/work/maya/scene'
    ...
    def getAniPub(self):
            ...
            aniPub_path = f'{current_proj}/{current_ep}/sequences/{currentShot}/animation/output/maya/showcase_animation'
    ...
    def layoutOpenWIPBtn(self):
        ...
        wip_file     = f'{PROJ_DRIVE}/{current_proj}/{current_ep}/sequences/{currentShot}/layout/work/maya/scene/{selected_file}'
    ...
    def layoutSaveWIPBtn(self):
        ...
        wip_path = f'{PROJ_DRIVE}/{current_proj}/{current_ep}/sequences/{currentShot}/layout/work/maya/scene'
    ...
    def layoutWipOpenFileBrowser(self):
        ...
        currentShot  = self.shot_list.currentItem().text()
        selected_file= self.layoutWip_list.currentItem().text()
        wip_file     = f'{PROJ_DRIVE}/{current_proj}/{current_ep}/sequences/{currentShot}/layout/work/maya/scene'
    ...
    def layoutOpenPubBtn(self):
        ...
        wip_file     = f'{PROJ_DRIVE}/{current_proj}/{current_ep}/sequences/{currentShot}/layout/output/maya/scene/{version}/{selected_file}'
        print ('wip_file = '+wip_file)
        cmds.file(wip_file, o=True, f=True)
    ...
    def layoutSavePubBtn(self):
        ...
        pub_path = f'{PROJ_DRIVE}/{current_proj}/{current_ep}/sequences/{currentShot}/layout/output/maya/scene'
        folder_list = os.listdir(pub_path)
        version_list = [folder for folder in folder_list if folder[-4] == 'v']
        if len(version_list) == 0:
            version = 'v001'
            filename = f'{currentShot}_layout_v001'
            
        else:
            version = os.listdir(pub_path)[-1]
            version = 'v'+str(int(version[-3:])+1).zfill(3)
    ...
    def layoutPubOpenFileBrowser(self):
        ...
        version = selected_file.split('.')[0]
        version = version.split('_')[-1]
        pub_file     = f'{PROJ_DRIVE}/{current_proj}/{current_ep}/sequences/{currentShot}/layout/output/maya/scene/{version}'
    ...
    def aniWipOpenFileBrowser(self):
        ...
        wip_file     = f'{PROJ_DRIVE}/{current_proj}/{current_ep}/sequences/{currentShot}/animation/work/maya/scene'
        os.startfile(wip_file)
    ...
    def aniPubOpenFileBrowser(self):
        ...
        version = selected_file.split('.')[0]
        version = version.split('_')[-1]
        pub_file     = f'{PROJ_DRIVE}/{current_proj}/{current_ep}/sequences/{currentShot}/animation/output/maya/showcase_animation/{version}'
        os.startfile(pub_file)
    ...
    def aniOpenWIPBtn(self):
        ...
        ani_file     = f'{PROJ_DRIVE}/{current_proj}/{current_ep}/sequences/{currentShot}/animation/work/maya/scene/{selected_file}'
    ...
    def aniSaveWIPBtn(self):
        ...
        wip_path = f'{PROJ_DRIVE}/{current_proj}/{current_ep}/sequences/{currentShot}/animation/work/maya/scene'
        file_list = os.listdir(wip_path)
        mb_list=[file for file in file_list if file.endswith('.mb')]
    ...
    def aniSavePubBtn(self):
        ...
        pub_path = f'{PROJ_DRIVE}/{current_proj}/{current_ep}/sequences/{currentShot}/animation/output/maya/showcase_animation'
        if not os.path.isdir(pub_path):
            os.makedirs(pub_path)
        folder_list = os.listdir(pub_path)
        version_list = [folder for folder in folder_list if folder[-4] == 'v']
        if len(version_list) == 0:
            ...
            version = os.listdir(pub_path)[-1]
            version = 'v'+str(int(version[-3:])+1).zfill(3)
            filename = f'{currentShot}_animation_'
            filename = filename + version
        ...
        asset_list = []
        for i in ref_list:
            asset_list.append((i.split('_')[0]).lower())
            ...
            with open(scene_csv) as f:
                ...
                for asset_type, asset_name in data:
                    if asset_type == 'character' or asset_type == 'prop':
                        abcPath = f'{PROJ_DRIVE}/{current_proj}/{current_ep}/sequences/{currentShot}/animation/output/animcache/animation_{asset_name}/{version}/alembic/'
                        abcName = f'{currentShot}_animation_{asset_name}_{version}.abc'
                        
                        for i in asset_list:
                            if asset_name.lower() == i.lower():
                                if not os.path.isdir(abcPath):
                                    ...
                                    command = '-frameRange ' + str(startFrame) + ' ' + str(endFrame) + ' -stripNamespaces -uvWrite -writeColorSets -writeFaceSets -wholeFrameGeo -worldSpace -writeVisibility -eulerFilter -autoSubd -writeUVSets -dataFormat ogawa -root ' + bakeObj + ' -file ' + abcPath + abcName
        ...
        if cmds.objExists('ETC|BAKE'):
            ...
            selectedObj = cmds.ls(selection = True, l=True)
            bakeObj = ' -root '.join(selectedObj)
            abcPath = f'{PROJ_DRIVE}/{current_proj}/{current_ep}/sequences/{currentShot}/animation/output/animcache/animation_ETC/{version}/alembic/'
            if not os.path.isdir(abcPath):
                os.makedirs(abcPath)
        ...
        if cmds.objExists('BG'):
            ...
            selectedObj = cmds.ls(selection = True, l=True)
            bakeObj = ' -root '.join(selectedObj)
            abcPath = f'{PROJ_DRIVE}/{current_proj}/{current_ep}/sequences/{currentShot}/animation/output/animcache/animation_BG/{version}/alembic/'
            if not os.path.isdir(abcPath):
                os.makedirs(abcPath)
            abcName = f'{currentShot}_animation_BG_{version}.abc'
            command = '-frameRange ' + '1' + ' ' + '1' + ' -stripNamespaces -uvWrite -writeColorSets -writeFaceSets -wholeFrameGeo -worldSpace -writeVisibility -eulerFilter -autoSubd -writeUVSets -dataFormat ogawa -root ' + bakeObj + ' -file ' + abcPath + abcName
            cmds.AbcExport ( j = command )
        ...
        if cmds.objExists('BGPROP'):
            ...
            selectedObj = cmds.ls(selection = True, l=True)
            bakeObj = ' -root '.join(selectedObj)
            abcPath = f'{PROJ_DRIVE}/{current_proj}/{current_ep}/sequences/{currentShot}/animation/output/animcache/animation_BGPROP/{version}/alembic/'
            if not os.path.isdir(abcPath):
                os.makedirs(abcPath)
        ...
        path = f'{PROJ_DRIVE}/{current_proj}/{current_ep}/sequences/{currentShot}/animation/output/camcache/animation_renderCam/{version}/fbx'
        if not os.path.isdir(path):
            os.makedirs(path)
        path = f'{PROJ_DRIVE}/{current_proj}/{current_ep}/sequences/{currentShot}/animation/output/camcache/animation_renderCam/{version}/fbx/{currentShot}_animation_renderCam_{version}'
        ...
        camName = camName[-2]
        cmds.select( camName )
        path = f'{PROJ_DRIVE}/{current_proj}/{current_ep}/sequences/{currentShot}/animation/output/camcache/animation_renderCam/{version}/alembic'
        if not os.path.isdir(path):
            os.makedirs(path)
        path = f'{PROJ_DRIVE}/{current_proj}/{current_ep}/sequences/{currentShot}/animation/output/camcache/animation_renderCam/{version}/alembic/{currentShot}_animation_renderCam_{version}.abc'
        command = '-frameRange ' + str(startFrame) + ' ' + str(endFrame) + ' -stripNamespaces -uvWrite -writeColorSets -writeFaceSets -wholeFrameGeo -worldSpace -writeVisibility -eulerFilter -autoSubd -writeUVSets -dataFormat ogawa -root ' + camName + ' -file ' + path
        cmds.AbcExport ( j = command )
    ...
    def aniOpenPubBtn(self):
        ...
        pub_file     = f'{PROJ_DRIVE}/{current_proj}/{current_ep}/sequences/{currentShot}/animation/output/maya/showcase_animation/{version}/{selected_file}'
        print ('pub_file = '+pub_file)
