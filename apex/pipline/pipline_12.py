    ...
    def assignShaderBtn(self):
        ...
        for sg in shader_dict['surface']:
            ...
            for obj in shader_dict['surface'][sg]['objects']:
                ...
                if (node.count('|') == 0) and (cmds.objExists(f"{UpperNode}|{obj.split('Shape')[0]}")):
                    self.errorMessage(f'!! Check the Shape Name of {obj} !!')
                ...
                if len(node) > 1:
                    ...
                    try:cmds.select(f"{UpperNode}|{obj.split('Shape')[0]}|{obj}")
                    except:print('Next')
