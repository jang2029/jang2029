...
class piplineToolUI(QWidget):
    ...
    def saveCurrentENV(self):
        ...
        env_docs = {
                    ...
                    'rigMiddle_name': rigMiddle_name, 'rig_Pub_ver': rig_Pub_ver, 'pub_rig' : pub_rig,
    ...
    def initUI(self):
        ...
        pub_rig_layout.addWidget(Rig_ref_btn)
        pub_rig_layout.addWidget(Rig_rep_btn)

        

        rigVersion_layout = QHBoxLayout()        
        rigVersion_layout.addLayout(rigWipVerLayout)
        rigVersion_layout.addLayout(wip_rig_layout)
        rigVersion_layout.addLayout(rigPubVerLayout)
        rigVersion_layout.addLayout(pub_rig_layout)
        ...
        rig_layoutA_grp = QGroupBox('Rig')
        rig_layoutA_grp.setLayout(rig_layoutA)

        rig_layout = QHBoxLayout()
        rig_layout.addLayout(rigMiddle_name_layout)
        rig_layout.addWidget(rig_layoutA_grp)
