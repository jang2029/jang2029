...
class LookdevUI(QWidget):
    ...
    def getVersion(self):
        ...
        wip_dir = self.getSaveDir('work') + '/geometry/model_main'
        ...
        pub_dir = self.getSaveDir('output') + '/geometry/model_main'
    ...
    def getModPubVersion(self):
        ...
        pub_dir = self.getModPubDir() + '/v034/maya'
    ...
    def publishBtn(self):
        ...
        # make Publish dir
        pub_maya_dir = self.getSaveDir('output') + '/shadegeo/shade_main'
        if not os.path.isdir(pub_maya_dir):
            os.makedirs(pub_maya_dir)
        pub_json_dir = self.getSaveDir('output') + '/json'
        ...
        #  regex string
        pattern_maya_str = '/shade/work/maya/scenes/increments/'
        dst_maya_str = '/shade/output/shadegeo/shade_main/v028/maya/maya_shd'
        dst_json_str = '/shade/output/shadegeo/shade_main/v028/maya/json'
    ...
    def openPubFileBrowser(self):
        ...
        pub_dir = self.getSaveDir('output') + '/shadegeo/shade_main/v028/maya'
