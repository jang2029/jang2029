    ...
    def publishBtn(self):
        ...
        for i in cmds.file(query=True, list=True):
            ...
            if not filename[-1] in ['', 'mb', 'ma', 'abc']:
                ...
                shutil.copy(i, pub_texture_path)
        ...
        for fileNode in fileNodes:
            ...
            print (orgPath)
            split_name = re.split('/shade/', orgPath)
            texture_name = re.split('/textures/', orgPath)
            print (split_name,texture_name)
            newName = (split_name[0] + '/output/shadegeo/shade_main/'+ wip_version+ '/maya/textures/'+ texture_name[1])
