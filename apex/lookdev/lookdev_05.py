...
class LookdevUI(QWidget):
    ...
    def getMiddleName(self):
        ...
        if os.path.isdir(department_dir):
            ...
            if 'shade' in middle_names:
                middle_names.pop(middle_names.index('shade'))
                self.middle_list.addItem('shade')
            for middle_name in sorted(middle_names):
                self.middle_list.addItem(middle_name)
        else:
            self.middle_list.addItem('model')
    ...
    def getModPubDir(self):
        ...
        save_dir = f'{department_dir}/{middle_name}/output'
    ...
    def openWIPFileBrowser(self):
        ...
        wip_dir = self.getSaveDir('work') + '/maya'
