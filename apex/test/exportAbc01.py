...
def exportAbc():
    ...
    bakeObj = ' '.join(selectedObj)
    print (bakeObj)
    command = '-frameRange ' + str(startFrame) + ' ' + str(endFrame) + ' -stripNamespaces -uvWrite -writeColorSets -writeFaceSets -wholeFrameGeo -worldSpace -writeVisibility -eulerFilter -autoSubd -writeUVSets -dataFormat ogawa -sl -ro ' + bakeObj + ' -file ' + abcFilename
